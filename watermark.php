 ...
 */
  ...
  function imagecreatefromfile($image_path) {
    ...
    /*switch ($image_type)
    {
	  ...
	  switch ($info['mime'])
		{
		  case 'image/gif': return imagecreatefromgif($image_path); break;
		  case 'image/jpg': return imagecreatefromjpeg($image_path); break;
		  case 'image/jpeg': return imagecreatefromjpeg($image_path); break;
		  case 'image/png': return imagecreatefrompng($image_path); break;
		  default: return ''; break;
		}
  }
