...
if(isset($_GET['act']) && $_GET['act']=='delete'){
	...
	$selQry = "select * from access where id = ".$eid;
	...
	{ 
		...
		$qry_images = "SELECT * FROM access_images where a_id = ".$eid;
		...
		$delQry = "delete from access where id = ".$eid;
		...
		$url = $SITE_URL.'admin/manage_access.php?msg=del';
...
$Qry = "SELECT access.*, access_model.model_id FROM access LEFT JOIN access_model ON access.id = access_model.access_id order by id DESC";
  ...
  <div class="row items-push">
    ...
    <div class="col-sm-4 text-right hidden-xs">
      ...
      <ol class="breadcrumb push-10-t">
        ...
        <li><a class="link-effect" href="add_access.php">Add Accessories</a></li>
        ...
        <table class="table table-bordered table-striped js-dataTable-full">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="font-w600"><?php echo $Row['a_name']; ?></td>

              <td class="hidden-xs"><?php echo Get_one_value('brands','brand_name',$Row['brand_id'],'id',$db) ?></td>

               <td class="text-center"><?php echo Get_one_value('models','model_name',$Row['model_id'],'id',$db) ?> / <?php echo $Row['a_type']==1?'Scooter':'Bike'; ?></td>

              <td class="font-w600 hidden-xs"><img src="<?php echo $SITE_URL?>images/product_images/<?php echo $Row['a_picture']; ?>"/ class="img-responsive" style="width:30%"></td>
              ...
              <td class="text-center "><div class="btn-group"> <a href="add_access.php?id=<?php echo $Row['id']; ?>">
