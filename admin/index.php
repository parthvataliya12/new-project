...
{ 
	...
	$ADMIN_USERNAME=$row->a_username;
	$ADMIN_PASSWORD=$row->a_password;
	if(trim($name)==trim($ADMIN_USERNAME) && trim($pass)==trim($ADMIN_PASSWORD))
	{		
                    ...
                    <form class="js-validation-login form-horizontal push-30-t push-50" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <button class="btn btn-block btn-primary" type="submit" name="submit" value='submit'><i class="si si-login pull-right"></i> Log in</button>
                            </div>
                        </div>
                    </form>
                    <!-- END Login Form -->
